...
[delete-stripe-card](03%20API's/Swagger/Providers/delete-stripe-card-sw.md)
[country-city-list](03%20API's/Swagger/Providers/country-city-list-sw.md)
[forgot-password](03%20API's/Swagger/Providers/forgot-password-sw.md)
[register-verification](03%20API's/Swagger/Providers/register-verification-sw.md)
[provider_referral_code](03%20API's/Swagger/Providers/provider_referral_code-sw.md)
[add_bank_detail](03%20API's/Swagger/Providers/add_bank_detail-sw.md)
[get_bank_detail](03%20API's/Swagger/Providers/get_bank_detail-sw.md)
[delete_bank_detail](03%20API's/Swagger/Providers/delete_bank_detail-sw.md)
[update-firebase-token](03%20API's/Swagger/Providers/update-firebase-token-sw.md)
[get_provider_referal_credit](03%20API's/Swagger/Providers/get_provider_referal_credit-sw.md)
[typelist-selectedcountrycity](03%20API's/Swagger/Providers/typelist-selectedcountrycity-sw.md)
[provider-create-trip](03%20API's/Swagger/Providers/provider-create-trip-sw.md)
[get-trip-status-provider](03%20API's/Swagger/Providers/get-trip-status-provider-sw.md)
