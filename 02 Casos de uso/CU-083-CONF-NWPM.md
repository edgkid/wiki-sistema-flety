## Caso de Uso: CU-083-CONF-NWPM - Agregar Promoción
...
| :--- | :--- |
| **id** | CU-083-CONF-NWPM |
| **Caso de Uso** | Agregar Promoción |
| **Actor Principal** | Usuario |
| **Actores Secundarios** | Software |
| **Objetivo** | Permite la creación de un nuevo código promocional. |
| **Prioridad** | |
...
* El usuario hizo clic en agregar promoción desde **CU-082-CONF-PRMO**.
...
| :--- | :--- |
| | El sistema muestra un formulario con los datos que se requieren para crear un código nuevo promocional. |
