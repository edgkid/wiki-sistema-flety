## Caso de Uso: CU-041-USU-BLUS - Dashboard de usuarios

Este caso de uso describe la funcionalidad para visualizar, filtrar y gestionar los perfiles de los usuarios que han sido rechazados o se encuentran en lista negra, permitiendo auditar su historial y decidir su posible aprobación o eliminación definitiva.
...
| 6) Puede aprobar un usuario. | 7) Aprueba y muestra un mensaje de éxito. |
...
| :--- | :--- |
| Cualquier cambio realizado a través del menú de opciones (como "Aprobado") se refleja inmediatamente. | La tabla se mantiene vacía. |
